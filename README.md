...
Version 1.6.0 fixes held-key return in Mono and Mono Legato for MIDI and the on-screen keyboard: releasing the newest key returns to the most recently pressed key still held, using its original velocity. Mono restarts the attack; Mono Legato continues the envelope.
